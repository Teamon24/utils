...
sealed class Tuple(val size: Int)

data class Quadruple<out A, out B, out C, out D>
constructor(val first: A, val second: B, val third: C, val forth: D): Tuple(4) {
    override fun toString(): String = toString(arrayOf(first, second, third, forth))
}

data class Quintuple<out A, out B, out C, out D, out E>
constructor(val first: A, val second: B, val third: C, val forth: D, val fifth: E): Tuple(5) {
    override fun toString(): String = toString(arrayOf(first, second, third, forth, fifth))
}

data class Sextuple<A, B, C, D, E, F>
constructor(val first: A, val second: B, val third: C, val forth: D, val fifth: E, val sixth: F): Tuple(6) {
...
fun toString(anys: Array<*>): String =
    "(${anys.joinToString(separator = ", ", truncated = "") { it.toString() }})"
/* ***************************************************************************************************************** */
/* ***************************************************** Triple-3 ************************************************** */
/* ***************************************************************************************************************** */
/**
...
infix fun <A, B, C, D, E, F>
        A.to(quintuple: Quintuple<B, C, D, E, F>) =
 ...
 */
infix fun <A, B, C, D, E, F>
        Pair<A, B>.to(quadruple: Quadruple<C, D, E, F>) =
    Sextuple(first, second, quadruple.first, quadruple.second, quadruple.third, quadruple.forth)
 ...
 */
infix fun <A, B, C, D, E, F>
        Triple<A, B, C>.to(triple: Triple<D, E, F>) =
    Sextuple(first, second, third, triple.first, triple.second, triple.third)
 ...
 */
infix fun <A, B, C, D, E, F>
        Quadruple<A, B, C, D>.to(pair: Pair<E, F>) =
    Sextuple(first, second, third, forth, pair.first, pair.second)
 ...
 */
infix fun <A, B, C, D, E, F>
        Quintuple<A, B, C, D, E>.to(sixth: F) =
    Sextuple(first, second, third, forth, fifth, sixth)
...
infix fun <A, B, C, D, E, F, G>
        A.to(sextuple: Sextuple<B, C, D, E, F, G>) =
    Septuple(this, sextuple.first, sextuple.second, sextuple.third, sextuple.forth, sextuple.fifth, sextuple.sixth)
/**
 * [2] to [5] = [7];
 * [Pair] to [Quintuple] = [Septuple]
 */
infix fun <A, B, C, D, E, F, G>
        Pair<A, B>.to(quintuple: Quintuple<C, D, E, F, G>) =
    Septuple(first, second, quintuple.first, quintuple.second, quintuple.third, quintuple.forth, quintuple.fifth)
/**
 * [3] to [4] = [7];
 * [Triple] to [Quadruple] = [Septuple]
 */
infix fun <A, B, C, D, E, F, G>
        Triple<A, B, C>.to(quadruple: Quadruple<D, E, F, G>) =
    Septuple(first, second, third, quadruple.first, quadruple.second, quadruple.third, quadruple.forth)
 ...
 */
infix fun <A, B, C, D, E, F, G>
        Quadruple<A, B, C, D>.to(triple: Triple<E, F, G>) =
    Septuple(first, second, third, forth, triple.first, triple.second, triple.third)
 ...
 */
infix fun <A, B, C, D, E, F, G>
        Quintuple<A, B, C, D, E>.to(pair: Pair<F, G>) =
    Septuple(first, second, third, forth, fifth, pair.first, pair.second)
 ...
 */
infix fun <A, B, C, D, E, F, G>
        Sextuple<A, B, C, D, E, F>.to(seventh: G) =
    Septuple(first, second, third, forth, fifth, sixth, seventh)
